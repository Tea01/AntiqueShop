...
{
    public partial class saticiKayit : Form
    {
        public saticiKayit()
        {
            InitializeComponent();
        ...
        private void Button_login_Click(object sender, EventArgs e)
        {
            ...
            //if login is successful, hide this form and show the main form for seller
            //passing username from the login form into main form

            try
            {
                conn.Open();
                NpgsqlCommand komut = new NpgsqlCommand("INSERT INTO satici(satici_id, satici_adi, sifre) values (@p1, @p2, @p3)", conn);

                komut.Parameters.AddWithValue("@p1", int.Parse(TextBox_satici_id.Text));
        ...
        private void saticiKayit_Load(object sender, EventArgs e)
        {
