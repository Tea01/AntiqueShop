...
{
    public partial class urunAraMusteri : Form
    {
        public urunAraMusteri()
        {
            InitializeComponent();
        }
        ...
        private void urunAraMusteri_Load(object sender, EventArgs e)
        {
            string sorgu = "select * from urun";
            NpgsqlDataAdapter da = new NpgsqlDataAdapter(sorgu, conn);
            DataSet ds = new DataSet();
            da.Fill(ds);
            dataGrid_urun.DataSource = ds.Tables[0];
        }
